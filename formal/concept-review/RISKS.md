...
| **R-D5-3** | Circuit/recursion soundness bug → undetectable counterfeiting; no non-ZK supply backstop; privacy hides the breach (Zcash-Orchard class) | D5 | — | High | Low–Med | Supply silently inflated; impossible to audit because shielded | Treat F15 circuit soundness as top gate; per-asset non-ZK auditable issuance-ceiling backstop | High | Recursion enlarges TCB; backstop limits blast radius, can't prove circuit correct |
