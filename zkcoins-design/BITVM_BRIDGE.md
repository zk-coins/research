...
> **Superseded.** The normative zkBTC token standard and bridge profile is [`zk-coins/zkbtc`](https://github.com/zk-coins/zkbtc/blob/main/spec/ZKBTC_TOKEN.md) §1.1.1. The holder registers into a cumulative, growth-only operator set **before the first mint**. This May draft is archived. Do not implement from it.
