...
| `RECURSIVE_ACCUMULATOR_CHECKPOINT.md` | new (concept, 2026-07-11) | Recursive compression of historical accumulator verification, with explicit live-admission, snapshot-availability, portable-coin-witness, and anchors-MMR prerequisites. Can reduce replay/storage substantially, but does not claim to remove `R-D7-3`/`P17` until the pruning gates are satisfied. |
